...
class Face_Recognition:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="FACE RECOGNITION",font=("times new roman",27,"bold"),bg="black",fg="GREEN")
...
#2nd img
        ...
        img_bottom = img_bottom.resize((955, 700), Image.Resampling.LANCZOS)
    ...
    #button
        ...
        b1_1.place(x=365,y=620,width=200,heigh=40)


    #---------------------------------attendance------------------------------------------------------------------------------------------------
    def mark_attendance(self,i,r,n,d):
        with open("praveen.csv","r+",newline="\n") as f:
...
#face recognition func
    ...
    def face_recog(self):
        ...
        while True:
            ...
            key = cv2.waitKey(1) & 0xFF  # Masking to handle different OS implementations
            if key == ord('q'):  # Use 'q' for quit instead of Enter
